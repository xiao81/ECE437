...
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_zero_in
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_port_out_in
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_result_in
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_WriteData_in
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_WriteData_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_instruction_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_PCSrc_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_pc_add4_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_dWEN_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_port_out_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_RegWEN_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_rdat2_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_rdat1_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_regWsel_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_halt_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_result_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_zero_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_RegDst_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_MemToReg_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_dREN_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_imm_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_shamt_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_rs_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_rt_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_rd_out
add wave -noupdate -group EX /system_tb/DUT/CPU/DP/prif/EX_ALUSrc_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_dmemload_in
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_instruction_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_PCSrc_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_pc_add4_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_dmemload_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_regWsel_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_RegWEN_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_result_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_halt_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_RegDst_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_MemToReg_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_dWEN_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_dREN_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_imm_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_shamt_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_rs_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_rt_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_rd_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_port_out_out
add wave -noupdate -expand -group MEM /system_tb/DUT/CPU/DP/prif/MEM_ALUSrc_out
...
add wave -noupdate -group huif /system_tb/DUT/CPU/DP/huif/lw_hazard
...
WaveRestoreCursors {{Cursor 1} {490734 ps} 0}
